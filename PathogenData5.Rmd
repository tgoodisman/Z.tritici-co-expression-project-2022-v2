...
for (i in 1:4) {
  ...
  GS.A.subset.df.noGrey = GS.A.subset.df[!GS.A.subset.df$module == "ME0",]
...
for (i in 1:4) {
  ...
  GS.B.subset.df.noGrey = GS.B.subset.df[!GS.B.subset.df$module == "ME0",]
...
for (i in 1:4) {
  ...
  GS.C.subset.df.noGrey = GS.C.subset.df[!GS.C.subset.df$module == "ME0",]
...
for (i in 1:4) {
  ...
  GS.D.subset.df.noGrey = GS.D.subset.df[!GS.D.subset.df$module == "ME0",]
...
pycnidia.A = read.table("Tables/gene_significance/stage_B/necrosis_B.csv", header = T, sep = ",")
...
pycnidia.A.ME24 = pycnidia.A[pycnidia.A$module == "ME24",]
pycnidia.B.ME24 = pycnidia.B[pycnidia.B$module == "ME24",]
necrosisLvl.B.ME13 = necrosisLvl.B[necrosisLvl.B$module == "ME13",]
earlyOnset.B.ME13 = earlyOnset.B[earlyOnset.B$module == "ME13",]
necrosis.C.ME13 = necrosis.C[necrosis.C$module == "ME13",]
pycnidia.C.ME24 = pycnidia.C[pycnidia.C$module == "ME24",]
necrosisLvl.C.ME6 = necrosisLvl.C[necrosisLvl.C$module == "ME6",]
earlyOnset.C.ME6 = earlyOnset.C[earlyOnset.C$module == "ME6",]
necrosisLvl.C.ME13 = necrosisLvl.C[necrosisLvl.C$module == "ME13",]
earlyOnset.C.ME13 = earlyOnset.C[earlyOnset.C$module == "ME13",]
pycnidia.D.ME24 = pycnidia.D[pycnidia.D$module == "ME24",]
...
signif.names.list  = list("pycnidia.A.ME24", "pycnidia.B.ME24", "necrosisLvl.B.ME13", "earlyOnset.B.ME13", "necrosis.C.ME13", "pycnidia.C.ME24", "necrosisLvl.C.ME6", "earlyOnset.C.ME6", "necrosisLvl.C.ME13", "earlyOnset.C.ME13", "pycnidia.D.ME24")
